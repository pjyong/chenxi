    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'chenxi_homepage');
            }

            return array (  '_controller' => 'ChenXi\\MainBundle\\Controller\\DefaultController::indexAction',  '_route' => 'chenxi_homepage',);
        }
        ...
        // chen_xi_user_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'chen_xi_user_homepage')), array (  '_controller' => 'ChenXi\\UserBundle\\Controller\\DefaultController::indexAction',));
        }
